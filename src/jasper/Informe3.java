...
public class Informe3 {
	public static void crearInforme(String ruta) {
	    try {
	    	InputStream jasper = Informe3.class.getResourceAsStream(ruta);
	    	
	        // Parameters for report
	        Map<String, Object> parameters = new HashMap<String, Object>();
	        
	        String cadenaConexion = "jdbc:mysql://localhost/supermercado?serverTimezone=" + TimeZone.getDefault().getID();
